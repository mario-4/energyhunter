...
function scene:create( event )
    ...
    local sleepyBug = display.newImageRect( "assets/splashPrincipal.png", 1024, 720 )       -- Create a new image, logo.png (900px x 285px) from the assets folder. Default anchor point is center.
