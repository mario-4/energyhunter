...
function scene:create( event )
    ...
    local sleepyBug = display.newImage( "assets/gui/conclusao.png", 900, 480 )       -- Create a new image, logo.png (900px x 285px) from the assets folder. Default anchor point is center.
    sleepyBug.x = display.contentCenterX        -- Assign the x value of the image to the center of the X axis.
    sleepyBug.y = display.contentCenterY+400       -- Assign the y value of the image.
